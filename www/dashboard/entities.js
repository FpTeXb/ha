...
const LIGHTS = [
  { id: "light.yeelink_cn_2027394738_ceil47_s_2_light", name: "客厅", room: "living",  x: 43.88, y: 56.20, hasRender: true,  kind: "ceil" },
  ...
  { id: "light.zhuwei",                                  name: "主卫",  room: "mbath",   x: 20.60, y: 44.80, hasRender: true,  kind: "ceil" },
  ...
  { id: "light.yeelink_cn_962306557_ceil45_s_2_light",  name: "书房",  room: "study",   x: 52.84, y: 32.90, hasRender: true,  kind: "ceil" },
  { id: "light.yeelink_cn_2103176439_ml13_s_2_light",   name: "洗手台", room: "mbath",   x: 41.63, y: 37.14, hasRender: true,  kind: "spot" },
  { id: "light.yeelink_cn_950517169_panel6_s_2_light",  name: "厨房",  room: "kitchen", x: 65.15, y: 37.23, hasRender: true,  kind: "ceil" },
  { id: "light.yeelink_cn_2104008081_ml13_s_2_light",   name: "厨房射灯", room: "kitchen", x: 64.45, y: 31.84, hasRender: true, kind: "spot" },
  ...
  { id: "light.lemesh_cn_782316947_wy02_s_2_light",     name: "餐厅",  room: "dining",  x: 59.20, y: 56.60, hasRender: true,  kind: "ceil" },
  { id: "light.yeelink_cn_2006173280_ceil45_s_2_light", name: "弟弟房", room: "brother", x: 28.26, y: 32.40, hasRender: true,  kind: "ceil" },
];

const CLIMATES = [
  { id: "climate.yj1226_cn_2141905176_air", name: "客厅空调 1", room: "living",  x: 72.65, y: 41.85, target: 22, current: 23 },
  { id: "climate.yj1226_cn_2141895500_air", name: "客厅空调 2", room: "living",  x: 46.42, y: 41.65, target: 22, current: 23 },
  { id: "climate.yj1226_cn_2141905191_air", name: "主卧空调", room: "master",  x: 24.29, y: 49.13, target: 20, current: 21 },
  { id: "climate.yj1226_cn_2141905179_air", name: "姐姐空调", room: "sister",  x: 80.45, y: 48.70, target: 24, current: 26 },
  { id: "climate.yj1226_cn_2141895509_air", name: "弟弟空调", room: "brother", x: 28.55, y: 39.24, target: 24, current: 25 },
  { id: "climate.yj1226_cn_2141895501_air", name: "书房空调", room: "study",   x: 55.43, y: 40.85, target: 23, current: 24 },
];
...
const CURTAINS = [
  ...
  { id: "cover.xiaomi_cn_877631863_acn010_s_2_curtain", name: "主卧窗纱",    room: "master",  x: 14.70, y: 76.20, open: 0 },
  { id: "cover.xiaomi_cn_876990609_acn010_s_2_curtain", name: "主卧窗帘",    room: "master",  x: 20.40, y: 76.20, open: 0 },
...
const SCENES = [
  ...
  { id: "scene.wake", name: "起床", icon: "sun" },
];
